...
const EventsInfo = () => {
  ...
  return (
    <div className="container mt-5">
      <h3 className="text-center mb-4 text-white">Event Details</h3>
      <div className="row">
        {eventsData && eventsData.map((event) => (
          <div className="col-md-4 mb-4" key={event.id}>
            <div className="card shadow-lg rounded" style={{ transition: 'transform 0.3s' }}>
            {event.image_url && (
                <img
                  src={event.image_url}
                  alt={event.name}
              ...
              <div className="card-body">
                ...
                <ul className="list-group list-group-flush">
                  <li className="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    {event.team_spot_1 && <span className="badge bg-success">Winner</span>}
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center">
                    <strong>2nd Place:</strong> {event.team_spot_2 || 'N/A'}
                    {event.team_spot_2 && <span className="badge bg-secondary">Runner-up</span>}
                  </li>
                  <li className="list-group-item d-flex justify-content-between align-items-center">
                    <strong>3rd Place:</strong> {event.team_spot_3 || 'N/A'}
                    {event.team_spot_3 && <span className="badge bg-info">Third</span>}
                  </li>
